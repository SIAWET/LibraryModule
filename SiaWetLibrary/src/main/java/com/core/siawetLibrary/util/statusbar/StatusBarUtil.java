package com.core.siawetLibrary.util.statusbar;
...
//                uiFlags |= View.SYSTEM_UI_FLAG_LAYOUT_STABLE;//隐藏NavigationBar时会留下空白
    ...
    // 更改状态栏颜色
    public static void setStatusBarColorOld(Activity context, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setTranslucentStatusOld(true, context);
        }
    ...
    @TargetApi(19)
    private static void setTranslucentStatusOld(boolean on, Activity context) {
